...
#saving only 2011 - 2012 crimes with limited columns - date, primary type, and community area
cat Crimes_2001topresent.csv | cut -d, -f3,6,14 | grep -v "\b/2001\b"| grep -v "\b/2002\b"| grep -v "\b/2003\b" | grep -v "\b/2004\b" | grep -v "\b/2005\b" | grep -v "\b/2006\b" | grep -v "\b/2007\b" | grep -v "\b/2008\b" | grep -v "\b/2009\b" |grep -v "\b/2016\b" | grep -v "\b/2017\b" | grep -v "\b/2010\b" >> Chicrimes.csv
